...
extension DoubleExt on double {
  ...
  /// Utility function
  ///
  static String _ofName(String? name) =>
      name == null || name == ''
          ? ' '
          : ' of $name ';
}